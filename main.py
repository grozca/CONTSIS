...
def _resolver_rfcs(rfc_arg: str) -> list[str]:
    ...
    config_candidates = [
        Path("data/config/rfc_names.json"),
        Path("data/config/rfc_names.example.json"),
    ]
    ...
    extract_dir = Path("data/boveda/extract")
    ...
    print("[ALL] No se encontro configuracion de RFCs ni carpetas en data/boveda/extract")
...
def _run_alertas(piloto: bool = False) -> None:
    ...
    import alertas_v2 as alertas_mod
