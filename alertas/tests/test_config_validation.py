...
from app.config_validation import ConfigValidationError, validar_config
...
def build_valid_config() -> dict:
    return {
        ...
        "reportes": {"carpeta_salida": "./reportes", "generar_excel": True, "generar_html": True, "retener_dias": 30},
    }
